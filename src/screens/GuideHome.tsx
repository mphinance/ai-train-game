...
export default function GuideHome() {
  ...
  return (
    <div className="anim-route mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      {/* EBOOK CTA PLACEHOLDER
          Wave 4 wires the epub build and inserts a real download link here.
          Do not invent the href; the epub is generated by scripts/build-epub.mjs
          and placed at public/downloads/practical-ai.epub by that wave.
      */}
      {/* <section className="mt-12 panel px-6 py-6 text-center">
        ...
        <p className="mb-4 text-ink-soft">
          Take the full guide offline as an epub. Read it on your phone, Kindle, or reader of choice.
        </p>
        <a href="/downloads/practical-ai.epub" className="...">Download (epub)</a>
      </section> */}
    </div>
  );
}
